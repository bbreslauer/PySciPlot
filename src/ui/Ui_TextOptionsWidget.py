...
class Ui_TextOptionsWidget(object):
    def setupUi(self, TextOptionsWidget):
        TextOptionsWidget.setObjectName("TextOptionsWidget")
        TextOptionsWidget.resize(490, 458)
        ...
        self.size.setProperty("value", 12)
        ...
        self.weight = QtGui.QComboBox(self.groupBox_3)
        self.weight.setMinimumSize(QtCore.QSize(100, 0))
        self.weight.setObjectName("weight")
        self.weight.addItem("")
        self.weight.addItem("")
        self.weight.addItem("")
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.FieldRole, self.weight)
        ...
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.LabelRole, self.label_32)
        self.color = QColorButton(self.groupBox_3)
        self.color.setStyleSheet("background-color: rgb(0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        self.color.setObjectName("color")
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.FieldRole, self.color)
        ...
        self.storedSettingsButton.setMinimumSize(QtCore.QSize(25, 0))
        ...
        self.gridLayout.addWidget(self.storedSettingsButton, 0, 2, 2, 1)
        ...
        self.label_8.setMinimumSize(QtCore.QSize(0, 14))
        ...
        self.horizontalalignment.setObjectName("horizontalalignment")
        self.horizontalalignment.addItem("")
        self.horizontalalignment.addItem("")
        self.horizontalalignment.addItem("")
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.horizontalalignment)
        ...
        self.verticalalignment.setObjectName("verticalalignment")
        self.verticalalignment.addItem("")
        self.verticalalignment.addItem("")
        self.verticalalignment.addItem("")
        self.verticalalignment.addItem("")
        ...
        self.gridLayout.addWidget(self.buttons, 2, 0, 1, 3)

        self.retranslateUi(TextOptionsWidget)
        QtCore.QObject.connect(self.rotation, QtCore.SIGNAL("currentIndexChanged(QString)"), TextOptionsWidget.rotationBoxHandler)
        QtCore.QObject.connect(self.buttons, QtCore.SIGNAL("clicked(QAbstractButton*)"), TextOptionsWidget.buttonClickHandler)
        QtCore.QObject.connect(self.storedSettingsButton, QtCore.SIGNAL("clicked()"), self.storedSettingsButton.toggleWidget)
        QtCore.QObject.connect(self.color, QtCore.SIGNAL("clicked()"), self.color.createColorDialog)
        TextOptionsWidget.setTabOrder(self.name, self.size)
        TextOptionsWidget.setTabOrder(self.size, self.style)
        TextOptionsWidget.setTabOrder(self.style, self.horizontalalignment)
        TextOptionsWidget.setTabOrder(self.horizontalalignment, self.verticalalignment)
        TextOptionsWidget.setTabOrder(self.verticalalignment, self.rotation)
    ...
    def retranslateUi(self, TextOptionsWidget):
        ...
        self.weight.setItemText(0, QtGui.QApplication.translate("TextOptionsWidget", "normal", None, QtGui.QApplication.UnicodeUTF8))
        self.weight.setItemText(1, QtGui.QApplication.translate("TextOptionsWidget", "bold", None, QtGui.QApplication.UnicodeUTF8))
        self.weight.setItemText(2, QtGui.QApplication.translate("TextOptionsWidget", "light", None, QtGui.QApplication.UnicodeUTF8))
        self.label_32.setText(QtGui.QApplication.translate("TextOptionsWidget", "Color", None, QtGui.QApplication.UnicodeUTF8))
