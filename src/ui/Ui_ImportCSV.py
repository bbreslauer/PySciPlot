...
class Ui_ImportCSV(object):
    def setupUi(self, ImportCSV):
        ...
        self.gridLayout.addWidget(self.csvFileName, 0, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.loadDataButton, 4, 0, 1, 4)
        ...
        self.firstRowWaveNames.setText(_fromUtf8(""))
        self.firstRowWaveNames.setObjectName(_fromUtf8("firstRowWaveNames"))
        self.gridLayout.addWidget(self.firstRowWaveNames, 2, 1, 1, 1)
        ...
        ImportCSV.setTabOrder(self.otherDelimiter, self.firstRowWaveNames)
        ImportCSV.setTabOrder(self.firstRowWaveNames, self.defaultDataType)
        ImportCSV.setTabOrder(self.defaultDataType, self.loadDataButton)
    ...
    def retranslateUi(self, ImportCSV):
        ...
        self.label_3.setText(QtGui.QApplication.translate("ImportCSV", "Use first row for wave names", None, QtGui.QApplication.UnicodeUTF8))
