...
class Ui_BarPlotBars(object):
    def setupUi(self, BarPlotBars):
        BarPlotBars.setObjectName("BarPlotBars")
        ...
        self.barThickness.setProperty("value", 1.0)
        self.barThickness.setObjectName("barThickness")
        ...
        self.fillColor.setStyleSheet("background-color: rgb(0, 0, 255);\n"
"color: rgb(0, 0, 0);")
        ...
        self.edgeColor.setStyleSheet("background-color: rgb(0, 0, 0);\n"
"color: rgb(255, 255, 255);")
        ...
        self.edgeWidth.setObjectName("edgeWidth")
        ...
        QtCore.QObject.connect(self.addwavePairButton, QtCore.SIGNAL("clicked()"), BarPlotBars.addWavePairsToPlot)
        QtCore.QObject.connect(self.removewavePairButton, QtCore.SIGNAL("clicked()"), BarPlotBars.deleteSelectedWavePairs)
        QtCore.QObject.connect(self.wavePairTableView, QtCore.SIGNAL("customContextMenuRequested(QPoint)"), BarPlotBars.showWavePairListMenu)
        QtCore.QObject.connect(self.storedSettingsButton, QtCore.SIGNAL("clicked()"), self.storedSettingsButton.toggleWidget)
        QtCore.QObject.connect(self.edgeColor, QtCore.SIGNAL("clicked()"), self.edgeColor.createColorDialog)
        QtCore.QObject.connect(self.fillColor, QtCore.SIGNAL("clicked()"), self.fillColor.createColorDialog)
