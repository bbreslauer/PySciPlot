...
class Ui_PlotLegend(object):
    def setupUi(self, PlotLegend):
        PlotLegend.setObjectName("PlotLegend")
        ...
        self.frameon.setText("")
        self.frameon.setChecked(True)
        self.frameon.setObjectName("frameon")
        ...
        self.columnspacing.setProperty("value", 1.0)
        self.columnspacing.setObjectName("columnspacing")
        ...
        self.borderaxespad.setProperty("value", 0.5)
        self.borderaxespad.setObjectName("borderaxespad")
        ...
        self.handletextpad.setProperty("value", 0.5)
        self.handletextpad.setObjectName("handletextpad")
        ...
        self.handlelength.setProperty("value", 2.0)
        ...
        self.borderpad.setProperty("value", 0.3)
        self.borderpad.setObjectName("borderpad")
        ...
        self.labelspacing.setProperty("value", 0.5)
        ...
        QtCore.QObject.connect(self.frameon, QtCore.SIGNAL("toggled(bool)"), self.fancybox.setEnabled)
        QtCore.QObject.connect(self.storedSettingsButton, QtCore.SIGNAL("clicked()"), self.storedSettingsButton.toggleWidget)
        QtCore.QObject.connect(self.font, QtCore.SIGNAL("clicked()"), self.font.showTextOptionsWidget)
